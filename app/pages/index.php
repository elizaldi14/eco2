...
<head>
    ...
    <link rel="stylesheet" href="../../public/assets/css/gridder.css">
...
<header class="header graphic">
    ...
    <div class="container">
        <div class="row">
            <div class="tiny-12 small-6 medium-5 tiny-center tiny-center small-start">
                <h1>What is Ecomania?</h1>
            ...
            <div class="tiny-12 small-6 medium-7 tiny-center small-end">
                <img src="../../public/assets/imgs/graphic-7.svg" alt="">
            </div>
        </div>
    </div>
</header>
        ...
        <div class="container">
            <div class="row tiny-middle">
                ...
                <div class="tiny-12 medium-7 tiny-center medium-start">
                    <img src="../../public/assets/imgs/graphic-8.svg" alt="green tech graphic">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row tiny-middle">
                <div class="tiny tiny-center">
                    ...
                    <p>Several websites exemplify outstanding performance while accomplishing much and maintaining a minimal carbon footprint.</p>

                    <div class="scroller" data-direction="left" data-speed="slow">
                        <div class="scroller__inner">
                            <!-- piraffe.com -->
                            <div class="scroller__item">
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            <div class="menu">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>piraffe.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/piraffe.com.png" alt="piraffe.com preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=piraffe.com">piraffe.com</a><br>
                                    A+ | 0.02g CO2/view
                                </p>
                            </div>
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>smashingmagazine.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/smashingmagazine.com.png" alt="smashingmagazine.com preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=smashingmagazine.com">smashingmagazine.com</a><br>
                                    A | or 0.08g CO2/view
                                </p>
                            </div>
                            <!-- css-tricks.com -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>css-tricks.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/css-tricks.com.png" alt="css-tricks.com preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=css-tricks.com">css-tricks.com</a><br>
                                    A- | or 0.33g CO2/view
                                </p>
                            </div>
                            <!-- qampo.com -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>qampo.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/qampo.com.png" alt="qampo.com preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=qampo.com">qampo.com</a><br>
                                    A+ | or 0.03g CO2/view
                                </p>
                            </div>
                            <!-- comp.actor -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>comp.actor</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/comp.actor.png" alt="comp.actor preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=comp.actor">comp.actor</a><br>
                                    A+ | or 0.2g CO2/view
                                </p>
                            </div>
                            <!-- leakedpassword.com -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>leakedpassword.com</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/leakedpassword.com.png" alt="leakedpassword.com preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=leakedpassword.com">leakedpassword.com</a><br>
                                    A+ | or 0.05g CO2/view
                                </p>
                            </div>
                        </div>
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>tympanus.net/codrops/</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/codrops.png" alt="tympanus.net/codrops/ preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=tympanus.net/codrops/">tympanus.net/codrops/</a><br>
                                    A | or 0.21g CO2/view
                                </p>
                            </div>
                            <!-- mercura.io -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>mercura.io</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/mercura.io.png" alt="mercura.io preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=mercura.io">mercura.io</a><br>
                                    A- | or 0.26g CO2/view
                                </p>
                            </div>
                            <!-- astro.build -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>astro.build</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/astro.build.png" alt="astro.build preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=astro.build">astro.build</a><br>
                                    A+ | or 0.057g CO2/view
                                </p>
                            </div>
                            <!-- colordrop.io -->
                            <div class="scroller__item">
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>colordrop.io</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/colordrop.io.png" alt="colordrop.io preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=colordrop.io">colordrop.io</a><br>
                                    A+ | or 0.05g CO2/view
                                </p>
                            </div>
                            <!-- wordboss.de -->
                                ...
                                <div class="browser-window-osx" style="border:0;box-shadow:0px 2px 10px 0px rgba(50, 50, 50, 0.2);">
                                    <div class="header">
                                        <div class="left">
                                            ...
                                            <div class="search" style="width: 100%;">
                                                <p><span>https://</span>wordboss.de</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="window" style="height: 200px;">
                                        <img class="preview-image" src="/assets/img/wordboss.de.png" alt="wordboss.de preview">
                                    </div>
                                </div>
                                <p>
                                    <a href="/site/?url=wordboss.de">wordboss.de</a><br>
                                    A | or 0.17g CO2/view
                                </p>
                            </div>
                        </div>
...
<?php include '../pages/includes/footer-1.php';?>
...
<script>
document.querySelector('.websiteSubmit').addEventListener('click',
    function(event) {
        event.preventDefault();
    });
</script>

<script src="../../public/assets/js/countUp.js"></script>
...
<!-- <script>
    ...
    var websites = new CountUp("nbr", 0, 589250, 0, 1.3, options);
    websites.start();
    setInterval(countWebsites, 5000);
</script> -->
